    ...
    a.fn.waterwheelCarousel = function(r) {
        ...
        function d() {
            t.itemsContainer.find("img").each(function() {
                if (
                    a(this).data("original_width") == undefined ||
                    c.forcedImageWidth > 0
                ) {
                    a(this).data("original_width", a(this).width());
                }
                if (
                    a(this).data("original_height") == undefined ||
        ...
        function p(v) {
            if (t.currentlyMoving === false) {
                ...
                if (c.quickerForFurther === true) {
                    ...
                    t.currentSpeed =
                        t.currentSpeed < 100 ? 100 : t.currentSpeed;
                }
        ...
        a(document).keydown(function(u) {
            if (c.keyboardNav) {
                if (
                    (u.which === 37 && c.orientation == "horizontal") ||
                    ...
                    if (
                        (u.which === 39 && c.orientation == "horizontal") ||
                ...
                if (
                    c.keyboardNavOverride &&
                    ((c.orientation == "horizontal" &&
                        (u.which === 37 || u.which === 39)) ||
                        (c.orientation == "vertical" &&
                            (u.which === 38 || u.which === 40)))
                ) {
                    u.preventDefault();
                    return false;
                }
